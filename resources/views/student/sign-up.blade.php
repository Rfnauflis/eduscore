                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" action="{{ route('student.store') }} " method="POST">
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-gray-900 fw-bolder mb-3">Students Sign Up</h1>
                                <!--end::Title-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
                            ...
                            <!--end::Submit button-->
                            <!--begin::Sign up-->
                            <div class="text-gray-500 text-center fw-semibold fs-6">Sudah adakah yang gantikanku?
                            <a href="{{ route('sign-in') }}" class="link-primary">Sudah</a></div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
                    </div>
